...
class SilverShopWidget extends StatefulWidget {
  const SilverShopWidget({super.key});

  @override
  State<SilverShopWidget> createState() => _AllState();
}

class _AllState extends State<SilverShopWidget> {
