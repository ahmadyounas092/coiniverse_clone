...
class BimetallicShopWidget extends StatefulWidget {
  const BimetallicShopWidget({super.key});

  @override
  State<BimetallicShopWidget> createState() => _AllState();
}

class _AllState extends State<BimetallicShopWidget> {
