...
class GoldShopWidget extends StatefulWidget {
  const GoldShopWidget({super.key});

  @override
  State<GoldShopWidget> createState() => _AllState();
}

class _AllState extends State<GoldShopWidget> {
